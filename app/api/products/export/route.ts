    ...
    try {
        ...
        const csvRows = products.map(product => {
            const fields = [
                ...
                product.category || '',
                product.brand || '',
                product.lowestPriceIncShipping?.toString() || '',
                product.unit || '',
                product.lowestPricedOfferInventory?.toString() || '',
                product.isPreOrder ? 'Yes' : 'No',
                product.estimatedDeliveryTimeWeeks?.toString() || '',
                product.numberOfOffers?.toString() || '',
                product.totalInventoryAllOffers?.toString() || '',
                product.productUrl || '',
                product.imageUrl || '',
            ];
